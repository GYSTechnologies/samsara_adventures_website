...
//         theme="colored"
//         toastClassName={() =>
//           "relative flex p-1 min-h-10 rounded-md justify-between overflow-hidden cursor-pointer bg-white dark:bg-gray-800 text-gray-900 dark:text-white shadow-lg"
//         }
