...
//     const res = await signup(form, true);
//     if (res.success) {
//       setStep(2);
//     }
//   };
...
//                       />
//                       <label className="absolute inset-0 rounded-full cursor-pointer group-hover:bg-black/20 transition-all duration-200 flex items-center justify-center opacity-0 group-hover:opacity-100">
...
//               {/* Profile Image Upload - Compact Version */}
//               {!profileImage && (
//                 <div className="flex justify-center mb-4">
//                   <label className="relative w-12 h-12 rounded-full bg-gradient-to-br from-blue-100 to-indigo-100 border-2 border-dashed border-blue-300 flex items-center justify-center cursor-pointer hover:from-blue-200 hover:to-indigo-200 hover:border-blue-400 transition-all duration-200 group">
