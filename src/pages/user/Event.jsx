...
const Events = () => {
  ...
  return (
    <>
      {/* <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
          ...
          <button 
            ...
            className="inline-flex items-center px-6 py-3 lg:px-8 lg:py-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg lg:rounded-xl text-sm lg:text-lg shadow-2xl hover:shadow-blue-500/25 transform hover:scale-105 transition-all duration-300 space-x-2"
          >
            <span>View Upcoming Events</span>
            <svg
              className="w-4 h-4 lg:w-5 lg:h-5"
      ...
      <div id="events-section" className="bg-gray-50 mt-20 mb-50">
        <EventsSections />
      </div>
      {/* <TestimonialCarousel /> */}
    </>
