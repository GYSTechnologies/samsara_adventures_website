...
//         <div className="absolute -top-40 -right-40 w-96 h-96 bg-gradient-to-br from-blue-400 to-purple-600 rounded-full opacity-10 blur-3xl animate-pulse"></div>
//         <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-gradient-to-tr from-indigo-400 to-pink-600 rounded-full opacity-10 blur-3xl animate-pulse"></div>
//         <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-gradient-to-r from-purple-400 to-indigo-400 rounded-full opacity-5 blur-3xl"></div>
//       </div>

//       <div className="max-w-lg w-full bg-white/85 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/30 p-8 relative z-10">
//         {/* Header Section */}
...
//                 className="w-full px-4 py-3 pl-11 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 bg-gray-50/50 hover:bg-white hover:border-gray-300"
//                 placeholder="Enter your email address"
//                 required
//               />
//               <Mail className="w-5 h-5 text-gray-400 absolute left-3 top-3.5 group-focus-within:text-indigo-500 transition-colors" />
//             </div>
//           </div>
...
//                 onChange={handleInputChange}
//                 className="w-full px-4 py-3 pl-11 pr-11 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 bg-gray-50/50 hover:bg-white hover:border-gray-300"
//                 placeholder="Enter your password"
//                 required
//               />
//               <Lock className="w-5 h-5 text-gray-400 absolute left-3 top-3.5 group-focus-within:text-indigo-500 transition-colors" />
//               <button
//                 type="button"
//                 onClick={() => setShowPassword(!showPassword)}
//                 className="absolute right-3 top-3.5 text-gray-400 hover:text-indigo-500 transition-colors"
//               >
//                 {showPassword ? (
...
//               className="text-indigo-600 hover:text-indigo-500 font-semibold hover:underline transition-all duration-200"
//             >
//               Sign up here
//             </button>
//           </p>
